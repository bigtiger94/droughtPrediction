...
for (kk in c(1:4)){
  ...
  temp.obs.dphase = year(obs.sri.dphase.ts) %in% validyear %>% obs.sri.dphase.ts[.,-1] %>% 
            apply(., 1, sum) %>% xts(., ymd(names(.)))#
  # temp.obs.sri.dphase = obs.sri.dphase[,5]
  temp.det.raw.dphase = year(rawensmean.sri.dphase.ts) %in% validyear %>% rawensmean.sri.dphase.ts[.,-1]%>%
            apply(., 1, sum) %>% xts(., ymd(names(.)))#
  temp.det.up.dphase = year(upensmean.sri.dphase.ts) %in% validyear %>% upensmean.sri.dphase.ts[.,-1]%>%
            apply(., 1, sum) %>% xts(., ymd(names(.)))#
  # temp.det.sri.dphase = ensmean.sri.dphase[,5]
  
  temp.prob.raw.dphase = year(prob.rawenssri.dphase.over.ts)%in%validyear %>% prob.rawenssri.dphase.over.ts[.,2]
    
  temp.prob.up.dphase = year(prob.upenssri.dphase.over.ts)%in%validyear %>% prob.upenssri.dphase.over.ts[.,2]#
  ...
  temp.obs.dphase = year(obs.sri.dphase.ts) %in% validyear %>% obs.sri.dphase.ts[.,-1:-2] %>% 
    apply(., 1, sum) %>% xts(., ymd(names(.)))#
  temp.det.raw.dphase = year(rawensmean.sri.dphase.ts) %in% validyear %>% rawensmean.sri.dphase.ts[.,-1:-2]%>%
    apply(., 1, sum) %>% xts(., ymd(names(.)))#
  temp.det.up.dphase = year(upensmean.sri.dphase.ts) %in% validyear %>% upensmean.sri.dphase.ts[.,-1:-2]%>%
    apply(., 1, sum) %>% xts(., ymd(names(.)))#
  temp.prob.raw.dphase = year(prob.rawenssri.dphase.over.ts)%in%validyear %>% prob.rawenssri.dphase.over.ts[.,3]
  temp.prob.up.dphase = year(prob.upenssri.dphase.over.ts)%in%validyear %>% prob.upenssri.dphase.over.ts[.,3]#
  ...
  temp.obs.dphase = year(obs.sri.dphase.ts) %in% validyear %>% obs.sri.dphase.ts[.,-1:-3] %>% 
    apply(., 1, sum) %>% xts(., ymd(names(.)))#
  temp.det.raw.dphase = year(rawensmean.sri.dphase.ts) %in% validyear %>% rawensmean.sri.dphase.ts[.,-1:-3]%>%
    apply(., 1, sum) %>% xts(., ymd(names(.)))#
  temp.det.up.dphase = year(upensmean.sri.dphase.ts) %in% validyear %>% upensmean.sri.dphase.ts[.,-1:-3]%>%
    apply(., 1, sum) %>% xts(., ymd(names(.)))#
  temp.prob.raw.dphase = year(prob.rawenssri.dphase.over.ts)%in%validyear %>% prob.rawenssri.dphase.over.ts[.,4]
  temp.prob.up.dphase = year(prob.upenssri.dphase.over.ts)%in%validyear %>% prob.upenssri.dphase.over.ts[.,4]#
  ...
  temp.obs.dphase = year(obs.sri.dphase.ts) %in% validyear %>% obs.sri.dphase.ts[.,5] 
  temp.det.raw.dphase = year(rawensmean.sri.dphase.ts) %in% validyear %>% rawensmean.sri.dphase.ts[.,5]

  temp.det.up.dphase = year(upensmean.sri.dphase.ts) %in% validyear %>% upensmean.sri.dphase.ts[.,5]

  temp.prob.raw.dphase = year(prob.rawenssri.dphase.over.ts)%in%validyear %>% prob.rawenssri.dphase.over.ts[.,5]
  temp.prob.up.dphase = year(prob.upenssri.dphase.over.ts)%in%validyear %>% prob.upenssri.dphase.over.ts[.,5]#
...
BS.df %>% write.csv(., file.path(BSfilepath, paste0("BS_validperiod_",dindexname,"_",bsnname,".csv")))
