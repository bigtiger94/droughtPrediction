...
for (bsncase in c(1:length(bsnnames))){
     ...
     CI.df = CI_loocv(loocv.lm.mm, temp_df$SRI12, ALPHA)
     PI.df = PI_loocv(loocv.lm.mm, temp_df$SRI12, ALPHA)
     ...
     for (mm in c(2:12)){
          ...
          CI.df = rbind(CI.df, CI_loocv(loocv.lm.mm, temp_df$SRI12, ALPHA))
          PI.df = rbind(PI.df, PI_loocv(loocv.lm.mm, temp_df$SRI12, ALPHA))
